...
[![Build Status](https://travis-ci.com/sleepepi/af9-data-dictionary.svg?branch=master)](https://travis-ci.com/sleepepi/af9-data-dictionary)

### Exports

The AF9 data dictionary can be exported to CSV by typing:
...
The AF9 data dictionary is tested using the
...
[CHANGELOG](https://github.com/sleepepi/af9-data-dictionary/blob/master/CHANGELOG.md).
